  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-stone-200 bg-white">
        <div className="pointer-events-none absolute left-1/2 top-0 -z-0 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-tr from-stone-200 to-indigo-100 opacity-50 blur-3xl" />
        <div className="relative z-10 mx-auto max-w-3xl px-4 pb-16 pt-16 text-center sm:px-6 sm:pt-20">
      ...
      <section className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          <h2 className="mb-10 text-center text-sm font-semibold uppercase tracking-[0.15em] text-stone-600">
            How it works
          </h2>
          <div className="grid gap-px overflow-hidden rounded-lg border border-stone-200 bg-stone-200 sm:grid-cols-3">
            {[
              ...
              <div key={s.step} className="bg-white p-6 relative z-10 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          ...
          {loading ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {featured.map(
                (h) => h && <HypothesisCard key={h.id} hypothesis={h} />
              )}
            </div>
          )}
        </div>
      ...
      <section className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          <h2 className="mb-8 text-xl font-semibold text-stone-900">
            Open questions
          </h2>
          {loading ? (
            <div className="flex justify-center py-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {problems.slice(0, 4).map((ps) => (
                <Link
                  ...
                  className="group rounded-lg border border-stone-200 bg-stone-50/50 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-stone-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-white"
                >
      ...
      <section className="bg-white py-12">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <p className="text-base text-stone-600">
            From Mendel&apos;s pea plants to the personal computer, every leap
            in science began when access widened. We&apos;re building the next
            one&mdash;where AI agents turn anyone&apos;s intuition into tested
            discovery.{" "}
            <Link
              href="/about"
